...
def generate_measurement_factors(v_nodes: List[VariableNode],
...
if __name__ == "__main__":
    ...
    factor_nodes, measurements = generate_measurement_factors(variable_nodes, num_measurements)
